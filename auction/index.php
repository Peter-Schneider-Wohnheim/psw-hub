...
if (AUCTION_ACTIVE) {
    if (AUCTION_BIDDING_AVAILABLE) {
        ?>
        <p>In February 2024, bikes without an owner have been collected on the property. You now have the opportunity to
            buy
            one
            of those bikes.</p>

        <h3 class="h3 mt-5">1. Select a Bike</h3>
        <p>You can find photos of all bikes here: <a href="https://cloud.psw-wuerzburg.de/index.php/s/gK3gjHFwSy7cgLj"
                                                     target=”_blank”>PSW
                Cloud</a>.<br>
            Every bike has been assigned a unique number, the images are named accordingly. This number is also attached
            to
            the bike's handlebars
            with a red zip-tie. So, in case you want to see the bike in real, just go to the lower level of the parking
            lot
            behind house 3,
        ...
        <p>Search this table for the bike's number to find the current bid. If it does not show up, nobody has placed a
            bid
            yet. The bid you place needs to be higher than the current, highest bid.</p>
        <?php
    } else {
        echo '<div class="alert alert-light" role="alert">The auction is over. You can see the final bids below.</div>';
    }
    ...
    if (AUCTION_BIDDING_AVAILABLE) {
        ...
        <p>By filling out the form, you place a binding bid. The highest bid will receive the bike. Starting bid is 5 €.
            Your
        ...
        <p class="mb-5">Your bid should now show up in the table. Come back regularly to check, if a higher bid was
            placed.
            In this case,
